...
export const useHover = (
  ...
  const hoverStop = React.useCallback(
    (event: MouseEvent) => {
  ...
  return {
    style,
    onMouseEnter: rnStyle.hover ? hoverStart : onMouseEnter,
    onMouseLeave: rnStyle.hover ? hoverStop : onMouseLeave,
  };
};
...
export const useZIndex = (zIndexFromStyle: number) => {
  ...
  React.useEffect(() => {
    ...
    if (Platform.OS === 'ios' && zIndexFromStyle && zIndexFromStyle !== zIndex)
